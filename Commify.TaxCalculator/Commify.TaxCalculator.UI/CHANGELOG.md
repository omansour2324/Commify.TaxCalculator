...
- Create Angular project with ng: `ng new commify.taxcalculator.client --defaults --skip-install --skip-git `.
...
- Create project file (`commify.taxcalculator.client.esproj`).
